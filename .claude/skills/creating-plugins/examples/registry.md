...
**MetricRegistry** and **TransactionRegistry** are reserved for future use and have no defined contract yet. Reject any request to implement these registry types.
