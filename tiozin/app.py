...
from tiozin.status import AppStatus


class TiozinApp(Resource):
    """
    As the central hub of Tiozin's execution, TiozinApp assembles and runs one or more
    ...
    Typically, you create a TiozinApp instance in your entrypoint module like this:

        from tiozin.app import TiozinApp
        app = TiozinApp()
        app.run(job_name)

    Usage follows Tiozin's philosophy of simplicity: plug in the registries, call
    run(), and Tiozin handles the rest.
    """
