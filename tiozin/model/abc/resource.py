...
class Resource(ABC):
    """
    Base class for all resources in Tiozin, providing common attributes and logging.

    A Resource represents any managed entity in Tiozin, such as Jobs, Inputs, Transforms,
